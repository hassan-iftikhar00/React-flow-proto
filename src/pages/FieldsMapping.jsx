...
export default function FieldsMapping({ onClose }) {
  ...
  const handleDragEnd = (result) => {
    ...
    items.forEach((item) => {
      const originalIndex = list.findIndex(
        (l) => l.mappingName === item.mappingName
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TextColumns size={24} color="#AA96DA" weight="duotone" />
          Fields Mapping
        </h3>
        {onClose && (
          <button
                ...
                <div style={{ display: "flex", gap: "10px", marginTop: "5px" }}>
                  {sourceFields.map((f) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={sourceFilter.includes(f)}
                      ...
                      <table className="dnis-table">
                        ...
                        <tbody>
                          ...
                          {currentRecords.map((row, index) => {
                            ...
                            return (
                              <Draggable
                                key={row.mappingName + actualIdx}
                                draggableId={row.mappingName + actualIdx}
                                index={index}
                              >
                                {(provided) => (
                                  <tr
                ...
                <div className="sticky-wrapper">
                  <div className="form">
                    ...
                    <div className="input-group">
                      ...
                      />
                      {errors.mappingName && (
                        <span className="error-msg">{errors.mappingName}</span>
                      )}
                    </div>
                    <div className="input-group">
                      ...
                      <div
                        className={`custom-dropdown ${
                          sourceDropdown ? "show-options" : ""
                        } ${errors.sourceField ? "error-border" : ""}`}
                      >
                        <div
                          className="selected"
                      ...
                      {errors.sourceField && (
                        <span className="error-msg">{errors.sourceField}</span>
                      )}
                    </div>
                    <div
